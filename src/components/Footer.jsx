    ...
    <section id="contact" className="max-w-6xl mx-auto px-6 pb-20">
      <div className="bg-white/5 border border-white/10 rounded-2xl text-center py-16">
        ...
        <div className="flex justify-center gap-4">
          <a href="https://www.linkedin.com/in/sudeep-raj-0106b1420/" className="border border-cyan-400/40 text-cyan-400 px-5 py-2 rounded-lg text-sm">
            LinkedIn ↗
          </a>
          ...
          <a
            ...
            className="border border-cyan-400/40 text-cyan-400 px-5 py-2 rounded-lg text-sm"
          >
            Email ↗
          </a>
        </div>
